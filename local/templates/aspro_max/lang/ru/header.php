...
$MESS["REVIEW"] = 'Оставить отзыв';
$MESS["S_CALLBACK"] = 'Заказать звонок';
$MESS["UNTIL_AKC"] = 'До конца акции';
$MESS["TITLE_QUANTITY_BLOCK"] = 'Остаток';
$MESS["TITLE_QUANTITY"] = 'шт';
$MESS["TOTAL_SUMM_ITEM"] = 'Общая стоимость ';
$MESS["SUBSCRIBE_SUCCESS"] = 'Вы успешно подписались';

$MESS["RECAPTCHA_TEXT"] = 'Подтвердите, что вы не робот';
$MESS["JS_RECAPTCHA_ERROR"] = 'Пройдите проверку';

$MESS["COUNTDOWN_SEC"] = 'сек';
$MESS["COUNTDOWN_MIN"] = 'мин';
$MESS["COUNTDOWN_HOUR"] = 'час';
$MESS["COUNTDOWN_DAY0"] = 'дн';
$MESS["COUNTDOWN_DAY1"] = 'дн';
$MESS["COUNTDOWN_DAY2"] = 'дн';
...
$MESS["COUNTDOWN_COMPACT_SEC"] = 'с';
$MESS["COUNTDOWN_COMPACT_MIN"] = 'м';
$MESS["COUNTDOWN_COMPACT_HOUR"] = 'ч';
$MESS["COUNTDOWN_COMPACT_DAY"] = 'д';
$MESS["COUNTDOWN_COMPACT_WEAK"] = 'н';
$MESS["COUNTDOWN_COMPACT_MONTH"] = 'м';
$MESS["COUNTDOWN_COMPACT_YEAR0"] = 'л';
$MESS["COUNTDOWN_COMPACT_YEAR1"] = 'г';
...
$MESS['CUSTOM_COLOR_CHOOSE'] = 'Выбрать';
$MESS['CUSTOM_COLOR_CANCEL'] = 'Отмена';
$MESS['S_MOBILE_MENU'] = 'Меню';
$MESS['MAX_T_MENU_BACK'] = 'Назад';
$MESS['MAX_T_MENU_CALLBACK'] = 'Обратная связь';
$MESS['MAX_T_MENU_CONTACTS_TITLE'] = 'Будьте на связи';

$MESS['SEARCH_TITLE'] = 'Поиск';
$MESS['SOCIAL_TITLE'] = 'Оставайтесь на связи';
$MESS['HEADER_SCHEDULE'] = 'Время работы';
$MESS['SEO_TEXT'] = 'SEO описание';
$MESS['COMPANY_IMG'] = 'Картинка компании';
$MESS['COMPANY_TEXT'] = 'Описание компании';

$MESS['CONFIG_SAVE_SUCCESS'] = 'Настройки сохранены';
$MESS['CONFIG_SAVE_FAIL'] = 'Ошибка сохранения настроек';
...
$MESS['PRICES_TYPE'] = 'Варианты цен';

$MESS['FILTER_HELPER_VALUES'] = ' знач.';

$MESS["SHOW_MORE_SCU_MAIN"] = "Еще #COUNT#";

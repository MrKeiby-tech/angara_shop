...
$APPLICATION->SetPageProperty("title", "Полезно знать, пиломатериалы статьи");
$APPLICATION->SetPageProperty("keywords", "Полезно знать пиломатериал статья");
$APPLICATION->SetPageProperty("description", "Компания «Форест» - это профессиональный коллектив оказывающий услуги по продажи и доставке пиломатериалов заказчику. Здесь Вы найдете полезные статьи про пиломатериалы.");
